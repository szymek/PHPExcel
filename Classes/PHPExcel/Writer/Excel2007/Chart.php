...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeTitle(PHPExcel_Chart_Title $title = null, $objWriter = null)
    {
        if (is_null($title)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeLegend(PHPExcel_Chart_Legend $legend = null, $objWriter = null)
    {
        if (is_null($legend)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeLayout(PHPExcel_Chart_Layout $layout = null, $objWriter = null)
    {
